<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.categories.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-lg transition-colors">
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-gray-500">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <a href="{{ route('admin.categories.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">
                                                Create Category
                                            </a>
                                        </div>
                                    </td>
    ...
    <script>
        function deleteCategory(id, name) {
            Swal.fire({
                title: 'Are you sure?',
                text: `You won't be able to revert this! Delete category "${name}"?`,
                icon: 'warning',

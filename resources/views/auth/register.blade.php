<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <!-- Register Button -->
        <button type="submit"
                class="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
    ...
    <div class="mt-6 text-center">
        <p class="text-gray-600">
            ...
            <a href="{{ route('login') }}" class="text-green-600 hover:text-green-500 hover:underline font-medium transition-colors">
                Sign in here
            </a>
        </p>
    </div>

<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            @if (Route::has('password.request'))
                <a class="text-sm text-blue-600 hover:text-blue-500 hover:underline transition-colors" href="{{ route('password.request') }}">
                    Forgot password?
                </a>
            @endif
        </div>
    ...
    <div class="mt-6 text-center">
        <p class="text-gray-600">
            ...
            <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-500 hover:underline font-medium transition-colors">
                Create one here
            </a>
        </p>
    </div>
